...
#' This dataset has a smaller dimension compared to the simPSPdata simulated dataset and is used for testing and development purposes.
#' 
#'
#' @name simPSPdata0
#' @title Simulated data set for patients of PSP (Smaller Dimension)
#' @description
...
#'    }
#' @format A \code{data.frame} in the long format with 10265 rows and 14 variables
#' @source A Simulated data frame
#' @docType data
#' @keywords datasets
#' @usage data(simPSPdata0)
#' @seealso \code{\link{simPSPdata}}
#' 
"simPSPdata0"
